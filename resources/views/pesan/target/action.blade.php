<div class="flex align-items-center list-user-action">
    ...
    onclick="return confirm('{{$message}}') ? document.getElementById('target-delete-{{ $id }}').submit() : false"
    ...
    <form action="{{ route('target.delete', $id) }}" id="target-delete-{{ $id }}" method="post">
    @method('delete')
    @csrf
    </form>
</div>
