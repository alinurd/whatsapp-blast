  ...
  <div class="container-fluid navbar-inner">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item me-3">
        <a class="btn btn-primary d-flex align-items-center" aria-current="page" href="{{route('muzakki.index')}}" target="" style="top: 4px;">
      ...
      <li class="nav-item me-3">
        <a class="btn btn-secondary d-flex align-items-center" aria-current="page" href="https://hopeui.iqonic.design/pro/laravel" href="{{route('mustahik.index')}}" target="" style="top: 4px;">
