    ...
    <div class="container-fluid navbar-inner">
        <div class="d-flex align-items-center justify-content-between w-100 landing-header">
            ...
            <a href="{{ route('uisheet') }}" class="navbar-brand m-0 d-xl-flex d-none">
                <!--Logo start-->
                <img src="{{ asset('images/logo/logo.png') }}" alt="story-img" class="rounded-pill avatar-50"> 
                 <!--logo End-->
                <h6 class="logo-title" style="font-weight: bold; color: #118146;">Yayasan Amal Hasanah</h6>
            </a>
            <div class="d-flex align-items-center d-xl-none">
                ...
                <a href="{{ route('uisheet') }}" class="navbar-brand ms-3  d-xl-none">
                    ...
                    <!--logo End-->
                    <h5 class="logo-title text-secondary">Yayasan Amal Hasanah</h5>
                </a>
            </div>
