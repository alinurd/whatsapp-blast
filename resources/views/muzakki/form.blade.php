...
document.getElementById('Uang' + rowCount).addEventListener('change', function() {    if (this.checked) {
        document.getElementById('satuan'+ rowCount).textContent = 'Ripiah';
    }
}); 
...
document.getElementById('Uang0').addEventListener('change', function() {    if (this.checked) {
        document.getElementById('satuan0').textContent = 'Ripiah';
    }
}); 
